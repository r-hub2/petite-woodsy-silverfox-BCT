...
#' giving the virus access to the cell and thus facilitating the COVID-19 disease. The gene sequence is mapped to the alphabet \code{\{0,1,2,3\}} via the obvious map A->0, C->1, G->2, T->3.
#' @docType data
...
#' (\href{https://www.science.org/doi/10.1126/science.abb2762}{aaas})
