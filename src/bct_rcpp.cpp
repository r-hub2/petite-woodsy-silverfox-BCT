...
//' If a context with a smaller length than the maximum depth is not contained in the output, its associated count vector is 0. If the observed string is made up of characters, the counts are displayed ordered based on the alphabetical order of the letters.'Root' indicates the empty context.
//' @export
